              ...
              <div className="space-y-6">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h2 className="text-3xl font-bold text-foreground">{primarySkill.name}</h2>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-foreground">After You Learn It</p>
              ...
              <div className="space-y-4">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-foreground">{secondarySkill.name}</h3>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {resources.map((resource, index) => (
                  ...
                  >
                    <div className="space-y-4">
                      <div className="flex items-start justify-between">
                        <h3 className="font-bold flex-1 text-foreground">{resource.title}</h3>
