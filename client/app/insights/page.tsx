          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-start justify-between mb-8">
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-pretty mb-2 text-foreground">Performance Insights & Analytics</h1>
                      ...
                      >
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            ...
                            <h3 className="font-bold text-lg mb-1 text-foreground">{insight.title}</h3>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <p className="font-bold mb-1 text-foreground">{rec.action}</p>
