          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <section className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="flex items-start justify-between mb-4">
                <div>
                  <h1 className="text-4xl font-bold tracking-tight text-pretty mb-2 text-foreground">Intelligent Skill Gap Analyzer</h1>
                ...
                <Card className="p-4 border-border/40 bg-card/50 backdrop-blur-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">{criticalSkills}</p>
                ...
                <Card className="p-4 border-border/40 bg-card/50 backdrop-blur-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-foreground">{overallGapScore}%</p>
            ...
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
                ...
                {skillGapData.map((skill) => (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      <div
                        className={`px-2 py-1 rounded text-xs font-medium border ${priorityConfig[skill.priority as keyof typeof priorityConfig].color}`}
                      >
                        {priorityConfig[skill.priority as keyof typeof priorityConfig].label}
                      </div>
                    </div>
              ...
              <Card className="lg:col-span-2 p-6 border-border/40 bg-card/50 backdrop-blur-sm">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold mb-1 text-foreground">{selectedSkill.skill}</h2>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="p-4 rounded-lg bg-muted/30 border border-border/30">
                    ...
                    <p className="text-2xl font-bold text-foreground">{selectedSkill.current}%</p>
                  </div>
                  <div className="p-4 rounded-lg bg-primary/10 border border-primary/30">
                    <p className="text-xs text-primary font-medium mb-1">Target Level</p>
                    <p className="text-2xl font-bold text-primary">{selectedSkill.target}%</p>
                  </div>
                  <div className="p-4 rounded-lg bg-amber-500/10 border border-amber-500/30">
                    <p className="text-xs text-amber-600 font-medium mb-1">Gap to Fill</p>
                    <p className="text-2xl font-bold text-amber-600">{selectedSkill.gap}%</p>
                  </div>
                  <div className="p-4 rounded-lg bg-emerald-500/10 border border-emerald-500/30">
                    <p className="text-xs text-emerald-600 font-medium mb-1">Timeframe</p>
                    <p className="text-lg font-bold text-emerald-600">{selectedSkill.timeframe}</p>
                  </div>
                </div>
