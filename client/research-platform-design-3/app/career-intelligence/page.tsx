        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex items-start justify-between mb-4">
              <div>
                <h1 className="text-4xl font-bold tracking-tight text-pretty mb-2">Career Intelligence Center</h1>
          ...
          <section className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200">
            <Card className="p-8 border-border/40 bg-gradient-to-br from-card/50 to-card/30 backdrop-blur-sm">
              <div className="flex items-start gap-4 mb-6">
                ...
                <div>
                  <h2 className="text-2xl font-bold mb-1">AI-Powered Recommendations</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  >
                    ...
                    <h3 className="font-bold mb-2 group-hover:text-primary transition-colors">{rec.action}</h3>
